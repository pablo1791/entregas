 ...
 *
 */
void* al_get(ArrayList* this, int index)   // Retorna un puntero al elemento que se encuentra en el índice especificado
{
    void* returnAux = NULL;
 ...
 *
 */
int al_contains(ArrayList* this, void* pElement)  //Comprueba si existe el elemento que se le pasa como parámetro
{
    int returnAux = -1;
    int i;
    if(this != NULL && pElement != NULL)
 ...
 *
 */
int al_set(ArrayList* this, int index,void* pElement) //Inserta un elemento en el ArrayList, en el índice especificado.
{
    int returnAux = -1;
 ...
 *                  - ( 0) if Ok
 */
int al_remove(ArrayList* this,int index)  //Elimina un elemento del ArrayList, en el índice especificado
{
    int returnAux = -1;
 ...
 *                  - ( 0) if Ok
 */
int al_push(ArrayList* this, int index, void* pElement) //Desplaza los elementos e inserta en la posición index.
{
    int returnAux = -1;
 ...
 */
int al_indexOf(ArrayList* this, void* pElement) //Retorna el índice de la primera aparición de un elemento (element) en el ArrayList
{
    int returnAux = -1;
    int i;
    if(this != NULL && pElement != NULL)
...
//en el índice especificado y luego lo elimina de la lista.
{
    void* returnAux = NULL;
